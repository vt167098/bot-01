...
import com.gfc.bot01.modules.api.MulticastMessage;
import com.gfc.bot01.modules.api.PushMessage;
...
public class LineConnector {
  ...
  public void multicastMessage(String LINE_TOKEN, MulticastMessage multicastMessage) {
    executer.sendPostByJson(LINE_MULTICAST_API, LINE_TOKEN, multicastMessage.toString(),
        new Callback() {
          public void onResponse(Call call, Response response) throws IOException {
            System.out.println("發送成功");
            System.out.println(response.body().string());
  ...
  public void narrowcastMessage(String LINE_TOKEN, MulticastMessage multicastMessage) {
    executer.sendPostByJson(LINE_MULTICAST_API, LINE_TOKEN, multicastMessage.toString(),
        new Callback() {
          public void onResponse(Call call, Response response) throws IOException {
            System.out.println("發送成功");
